# main_warehouse_physical_count.py - Enhanced with Team Count Features (No Authentication)
...
st.set_page_config(
    ...
    page_icon="📦",
    layout="wide",
    initial_sidebar_state="collapsed"  # Changed to collapsed since we don't need auth info
)
...
def show_header():
    ...
    with col2:
        st.metric("User", st.session_state.user_display_name)
